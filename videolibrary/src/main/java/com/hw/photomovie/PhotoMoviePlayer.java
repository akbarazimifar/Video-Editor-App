...
public class PhotoMoviePlayer implements MovieTimer.MovieListener {
    ...
    public IMovieTimer mMovieTimer;
    ...
    public void setDataSource(PhotoMovie photoMovie) {
        ...
        Log.d("kkkk","mMovieTimer"+mMovieTimer.getCurrentPlayTime());
        setLoop(mLoop);
    }
   ...
   /* public void setRawSource( int res) {
        mMusicPlayer.setDataSource( res);
    }*/
    ...
    public void start() {
        ...
        Log.d("jjjj","duration :  "+mPhotoMovie.getDuration());
        mMovieTimer.start();
    }
    ...
    public void stop() {
        ...
        pause();
       // seekTo((mMovieTimer.getCurrentPlayTime()+1000));
        //seekTo(0);
        //mMovieTimer.
    }
